---
name: reajuste-de-aluguel-mcp
description: Reajuste de aluguel: aplique o índice do contrato (IGP-M, IPCA, INPC) sobre o valor atual e devolva o aluguel corrigido com o acumulado do período. Use quando o usuário pedir o reajuste anual ou o novo valor de um aluguel.
---

# Reajuste de Aluguel — REST API skill

Você tem acesso à **Reajuste de Aluguel** REST API na MCP.AI.
...
Este MCP também funciona via **conexão MCP** (Claude / Cursor) em `https://api.mcp.ai/p_reajuste-de-aluguel` — veja o [README](../../README.md). A skill acima é pra consumir a **REST API** direto (agente próprio / código).
